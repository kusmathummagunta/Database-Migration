...
if (xmlHttp==null)
 ...
 var url="mysqldatanew.jsp"
 else if(val=="Postgresql server"||val=="Postgre SQL server"||val=="Post Gre SQL Server"||val=="Post GRE SQL server")
		{var url="postgresqltest.jsp"
		 alert("DB Migration Successful from MySQL to Post GRE SQL")
		}
...
<tr bgcolor="#aaee00">
            <td height="23" colspan="2" align="center"><b>XML Based Database Migration From MySQL Server to Post GRESQL Server</b></td>
      </tr>
	  </table>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table class="table table-responsive table-bordered table-condensed">
		  <tr bgcolor="lightblue">
			...
			<option value="Postgresql server"> PostgreSQL server</option>
