 ...
 try {
		...
		Document document = db.parse("C:\\Program Files (x86)\\Apache Software Foundation\\Tomcat 7.0\\webapps\\ROOT\\mysqldata.xml");
		int p = 0;
	    ...
	    st.execute("Drop table if exists "+nltn.item(k).getFirstChild().getNodeValue());
