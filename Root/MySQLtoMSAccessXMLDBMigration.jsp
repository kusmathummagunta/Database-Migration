...
if (xmlHttp==null)
 ...
 else if(val=="MS Access"||val=="MSaccess"||val=="Msaccess"||val=="Ms access")
		{ var url="msaccesstest.jsp"
			 alert("DB Migration Successful from MySQL to MS Access")
		}
...
<tr bgcolor="#aaee00">
            <td height="23" colspan="2" align="center"><b>XML Based Database Migration From MySQL Server to MS Access</b></td>
      </tr>
	  </table>
