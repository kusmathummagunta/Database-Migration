 ...
 try {
        ...
        Document document = documentBuilder.parse("C:\\Program Files (x86)\\Apache Software Foundation\\Tomcat 7.0\\webapps\\ROOT\\mysqldesc.xml");
...
while(result.next()){
 ...
 Element row = document.createElement("Key");
          ...
          Element primary_key = document.createElement("PrimaryKey");
            primary_key.appendChild(document.createTextNode(rsColumns.getString(4)));
        ...
        StreamResult result = new StreamResult("C:\\Program Files (x86)\\Apache Software Foundation\\Tomcat 7.0\\webapps\\ROOT\\mysqldesc"
                + ".xml");
