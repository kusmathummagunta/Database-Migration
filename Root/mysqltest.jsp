 ...
 try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3307/sqlitedump","root","root");		
		...
		Document document = db.parse("C:\\Program Files (x86)\\Apache Software Foundation\\Tomcat 7.0\\webapps\\ROOT\\sqlitedata.xml");
		int p = 0;
